 ...
 * エラー表示コンポーネント
 */
const ChartError: React.FC<{ error: string; height?: number }> = ({ error, height = 400 }) => (
  <div className="text-center">
    <div className="h-6 text-red-400 font-semibold mb-2">エラーが発生しました</div>
    <div 
...
const ChartEmpty: React.FC<{ height?: number }> = ({ height = 400 }) => (
  <div className="text-center">
    <div className="h-6 text-gray-400 font-semibold mb-2">データがありません</div>
    <div 
      className="bg-gray-800/30 border border-gray-700/30 rounded-lg flex items-center justify-center"
      style={{ height: `${height}px` }}
    >
