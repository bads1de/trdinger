...
const AlgorithmCatalog: React.FC = () => {
  ...
  return (
    <div className="container mx-auto">
      ...
      {/* タブ */}
      <Tabs value={String(tabValue)} onValueChange={(value) => setTabValue(Number(value))} className="mb-6">
        <TabsList className="w-full">
          <TabsTrigger value="0" className="flex-1">全アルゴリズム</TabsTrigger>
          <TabsTrigger value="1" className="flex-1">タイプ別</TabsTrigger>
          <TabsTrigger value="2" className="flex-1">機能別</TabsTrigger>
        </TabsList>
      </Tabs>
