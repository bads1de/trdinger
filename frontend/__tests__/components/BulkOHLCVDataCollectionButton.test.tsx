/**
 * BulkOHLCVDataCollectionButton コンポーネントのテスト
 * 
...
describe('BulkOHLCVDataCollectionButton', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });
  ...
  describe('初期状態', () => {
    it('ボタンが正しくレンダリングされる', () => {
      render(<BulkOHLCVDataCollectionButton />);
  ...
  describe('コールバック', () => {
    it('成功時にonCollectionStartが呼ばれる', async () => {
      ...
      render(<BulkOHLCVDataCollectionButton onCollectionStart={mockOnStart} />);
    ...
    it('エラー時にonCollectionErrorが呼ばれる', async () => {
      ...
      render(<BulkOHLCVDataCollectionButton onCollectionError={mockOnError} />);
