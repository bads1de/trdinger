...
## 1. `backend/app/services/strategy_integration_service.py`
...
## 2. `backend/app/services/auto_strategy/` ディレクトリ
...
## 3. `backend/app/services/data_collection/` ディレクトリ
...
## 4. `backend/app/services/indicators/` ディレクトリ
...
## 5. `backend/app/services/ml/` ディレクトリ
...
## 6. `backend/app/services/optimization/` ディレクトリ
...
#### 2. BacktestDataService リファクタリング ✅ 完了
