...
from app.services.backtest.factories.auto_strategy_loader import AutoStrategyLoader, AutoStrategyLoaderError
...
class TestAutoStrategyLoader:
    ...
    def test_load_strategy_gene_success(self, loader):
        ...
        with patch("app.services.auto_strategy.genes.StrategyGene") as MockGeneClass, \
             patch("app.services.auto_strategy.serializers.serialization.GeneSerializer") as MockSerializerClass:
            
            MockSerializerClass.return_value.dict_to_strategy_gene.return_value = mock_gene
    ...
    def test_create_auto_strategy_class_success(self, loader):
        ...
        with patch.object(loader, 'load_strategy_gene', return_value=mock_gene), \
             patch("app.services.auto_strategy.strategies.universal_strategy.UniversalStrategy", UniversalStrategy):
