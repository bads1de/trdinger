...
class TestParseDatetime:
    ...
    def test_parse_iso_format_with_z(
...
class TestGetDbSession:
    ...
    def test_uses_existing_session(
        self, service: BaseDataCollectionOrchestrationService
    ):
    ...
    def test_creates_new_session_when_none(
        self, service: BaseDataCollectionOrchestrationService
    ):
...
class TestCreateSuccessResponse:
    ...
    def test_success_response_without_data(
        ...
        assert result["success"] is True
        assert (
            result.get("data") is None or "data" not in result or result["data"] is None
        )
