...
def test_realistic_short_conditions():
    """より現実的なショート条件のテスト"""
    print("=" * 80)
    print("より現実的なショート条件のテスト")
    print("=" * 80)
    ...
    try:
        ...
        # ロング条件: RSI < 30 (買われすぎ) AND close > SMA
        ...
        # ショート条件: RSI > 70 (売られすぎ) AND close < SMA
        ...
        strategy_gene = StrategyGene(
            id="test_realistic_short_strategy",
        ...
        with SessionLocal() as db:
            ...
            # バックテスト設定（より長い期間でテスト）
            config = {
                "strategy_name": "Test_Realistic_Short_Strategy",
                "symbol": "BTC/USDT:USDT",
                "timeframe": "1h",
                "start_date": datetime.now() - timedelta(days=30),  # 1ヶ月
...
if __name__ == "__main__":
    test_realistic_short_conditions()
