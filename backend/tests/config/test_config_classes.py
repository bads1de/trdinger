...
UnifiedConfig, GAConfig, GAProgressなどの設定クラスをテストする。
"""
...
class TestConfigValidation:
    ...
    def test_invalid_population_size(self):
        ...
        # unified_config版のGAConfigはPydantic BaseSettingsなので
        # 負の値も許容される。代わりにGAConfigRuntimeをテスト
        with pytest.raises(ValueError):
            GAConfigRuntime(population_size=-1)
...
class TestGAConfigRuntime:
    ...
    def test_post_init_validation_invalid_population_size(self):
        ...
        with pytest.raises(
            ...
            GAConfigRuntime(population_size=0)
    ...
    def test_post_init_validation_invalid_crossover_rate(self):
        ...
        with pytest.raises(
            ...
            GAConfigRuntime(crossover_rate=1.5)
    ...
    def test_post_init_validation_invalid_mutation_rate(self):
        ...
        with pytest.raises(
            ...
            GAConfigRuntime(mutation_rate=-0.1)
    ...
    def test_preprocess_ga_dict_defaults(self):
        """GA辞書前処理のデフォルト値設定テスト"""
        data = {}
        processed = GAConfigRuntime._preprocess_ga_dict(data)
