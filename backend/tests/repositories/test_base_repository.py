...
class TestRepositoryInitialization:
    ...
    def test_repository_with_different_model(self, mock_session: MagicMock) -> None:
        """異なるモデルクラスで初期化できる"""
...
class TestTimestampMethods:
    ...
    def test_get_latest_timestamp_success(self, repository: BaseRepository) -> None:
        """最新タイムスタンプが取得できる"""
    ...
    def test_get_latest_timestamp_none(self, repository: BaseRepository) -> None:
        """データがない場合Noneが返される"""
    ...
    def test_get_oldest_timestamp_success(self, repository: BaseRepository) -> None:
        """最古タイムスタンプが取得できる"""
    ...
    def test_get_date_range_success(self, repository: BaseRepository) -> None:
        """データ期間が取得できる"""
...
class TestRecordCountMethods:
    ...
    def test_get_record_count_success(self, repository: BaseRepository) -> None:
        """レコード数が取得できる"""
    ...
    def test_get_record_count_zero(self, repository: BaseRepository) -> None:
        """レコードがない場合0が返される"""
...
class TestDeleteOperations:
    ...
    def test_delete_all_records_success(self, repository: BaseRepository) -> None:
        """全レコード削除が成功する"""
        mock_result = MagicMock()
    ...
    def test_delete_records_by_filter_success(self, repository: BaseRepository) -> None:
        """フィルター付き削除が成功する"""
        mock_result = MagicMock()
    ...
    def test_delete_by_date_range_success(self, repository: BaseRepository) -> None:
        """期間指定削除が成功する"""
        mock_result = MagicMock()
        ...
        count = repository.delete_by_date_range("timestamp", start_time, end_time)

        assert count == 3
        repository.db.commit.assert_called_once()

    def test_delete_old_data_success(self, repository: BaseRepository) -> None:
        """古いデータ削除が成功する"""
        mock_result = MagicMock()
...
class TestFilteredDataRetrieval:
    ...
    def test_get_filtered_data_basic(
        ...
        results = repository.get_filtered_data(filters={"symbol": "BTC/USDT:USDT"})
    ...
    def test_get_filtered_data_with_limit(self, repository: BaseRepository) -> None:
        """リミット付きデータ取得"""
        mock_scalars = MagicMock()
...
class TestDataFrameConversion:
    ...
    def test_to_dataframe_empty_records(self, repository: BaseRepository) -> None:
    ...
    def test_to_dataframe_with_index(
        ...
        df = repository.to_dataframe(records, column_mapping, index_column="timestamp")
...
class TestDataStatistics:
    ...
    def test_get_data_statistics_success(self, repository: BaseRepository) -> None:
        """データ統計情報が取得できる"""
        mock_result = MagicMock()
...
class TestValidationMethods:
    ...
    def test_validate_records_empty(self, repository: BaseRepository) -> None:
        """空のレコードでTrueが返される"""
...
class TestErrorHandling:
    ...
    def test_delete_rollback_on_error(self, repository: BaseRepository) -> None:
        """削除エラー時にロールバックされる"""
