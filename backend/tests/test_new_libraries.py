...
def test_ml_signal_generator_import():
    """MLSignalGeneratorのインポートテスト"""
    try:
        ...
        print("✅ MLSignalGenerator import successful")
        
    except ImportError as e:
        pytest.fail(f"MLSignalGenerator import failed: {e}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        test_ml_signal_generator_import()
