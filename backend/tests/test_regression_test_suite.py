...
class TestRegressionTestSuite:
    ...
    def test_ga_algorithm_regression(self, baseline_config, test_data_v1):
        ...
        assert (
            current_results["convergence_generation"]
            == expected_results_v1["convergence_generation"]
        )
    ...
    def test_data_migration_backward_compatibility(self):
        ...
        # 後方互換性がある
        assert all(
            field in current_data_format["fields"]
            for field in previous_data_format["fields"]
        )
