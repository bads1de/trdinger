...
from app.services.auto_strategy.utils.metrics import filter_and_rank_strategies
...
def test_quality_selector_filters_and_ranks():
    ...
    selected, rejected = filter_and_rank_strategies(
        stats_list, min_trades=1, require_quality_threshold=True
    )
