...
def test_feature_adapter_adds_wavelet_features(sample_gene: StrategyGene, sample_ohlcv: pd.DataFrame) -> None:
    ...
    feature_df = adapter.gene_to_features(sample_gene, sample_ohlcv, apply_preprocessing=False)
