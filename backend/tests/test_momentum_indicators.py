...
class TestMomentumIndicators:
    ...
    def test_calculate_roc(self):
        """ROC計算のテスト"""
        data = pd.DataFrame({'close': [100, 102, 105, 103, 107, 110, 108, 112, 115, 118]})
    ...
    def test_calculate_pvo(self):
        """PVO計算のテスト"""
        data = pd.DataFrame({'volume': [1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700, 1800, 1900]})
    ...
    def test_negative_values_handling(self):
        """負値処理のテスト"""
        data = pd.DataFrame({'close': [-1, -2, -3, -4, -5]})  # 負の価格（現実的ではないが）
    ...
    def test_extreme_values(self):
        """極端な値のテスト"""
        data = pd.DataFrame({'close': [1000000, 2000000, 500000, 3000000]})  # 極端な価格
    ...
    def test_all_momentum_indicators(self):
        ...
        data = pd.DataFrame({
            'close': [100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115],
            'high': [102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117],
