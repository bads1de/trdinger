    ...
    try:
        ...
        try:
                ...
                try:
                    ...
                    if count_1d > 0:
                        ...
                        if latest_data:
                            data = latest_data[0]
                            print(
                                f"    最新: Close={data.close:.2f} Volume={data.volume:.0f}"
                            )
            ...
            for symbol in symbols:
                try:
                    ...
                    if oi_data:
                        ...
                        print(
                            f"  ✅ {symbol}: 最新OI = {oi_data[0].open_interest_value:,.0f}"
                        )
                    else:
            ...
            for symbol in symbols:
                try:
                    ...
                    if fr_data:
                        ...
                        print(
                            f"  ✅ {symbol}: 最新FR = {fr_rate:.6f} ({fr_rate*100:.4f}%)"
                        )
                    else:
            ...
            if best_symbol and best_symbol["score"] > 30:
                ...
                return {"data_available": False, "need_sample_data": True}
