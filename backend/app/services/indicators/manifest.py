...
MANIFEST: Dict[str, Dict[str, Any]] = {
    ...
    'TRIX': {
        'config': {
            ...
            'required_data': ['close'],
            'output_names': ['TRIX_0', 'TRIX_1', 'TRIX_2'],
            'default_output': 'TRIX_0',
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length', 'signal': 'signal'},
            'parameters': {'length': {'default_value': 14, 'min_value': 2, 'max_value': 200, 'description': 'TRIX計算期間'}, 'signal': {'default_value': 9, 'min_value': 2, 'max_value': 50, 'description': 'シグナル線期間'}},
            'pandas_function': None,
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'multiple',
            'return_cols': ['TRIX', 'TRIXs', 'TRIXh'],
            'multi_column': False,
    ...
    'TSI': {
        'config': {
            ...
            'parameters': {
                'fast': {'default_value': 13, 'min_value': 1, 'max_value': 200, 'description': '高速EMA期間'},
                'slow': {'default_value': 25, 'min_value': 2, 'max_value': 300, 'description': '低速EMA期間'},
                'signal': {'default_value': 13, 'min_value': 1, 'max_value': 200, 'description': 'シグナル期間'},
                'scalar': {'default_value': 100.0, 'min_value': 1.0, 'max_value': 200.0, 'description': 'スケーリング係数'},
                'drift': {'default_value': 1, 'min_value': 1, 'max_value': 10, 'description': '差分ドリフト'},
            },
            'pandas_function': 'tsi',
            'data_column': 'Close',
            'data_columns': None,
        ...
        'yaml': {
            'conditions': {'long': '{left_operand}_0 > {threshold}', 'short': '{left_operand}_0 < -{threshold}'},
            'scale_type': 'oscillator_plus_minus_100',
            'thresholds': {'normal': {'threshold': 25}},
            'type': 'momentum',
        },
    },
    'PGO': {
        'config': {
            ...
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'close': 'close', 'length': 'length'},
            'parameters': {'length': {'default_value': 14, 'min_value': 2, 'max_value': 200, 'description': 'PGO期間'}},
            'pandas_function': 'pgo',
            'data_column': None,
            'data_columns': ['High', 'Low', 'Close'],
            'returns': 'single',
        ...
        'yaml': {
            'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < -{threshold}'},
            'scale_type': 'momentum_zero_centered',
            'thresholds': {'normal': {'threshold': 0.5}},
            'type': 'momentum',
        },
    },
    'MASSI': {
        'config': {
            ...
            'parameters': {
                'fast': {'default_value': 9, 'min_value': 2, 'max_value': 60, 'description': '高速期間'},
                'slow': {'default_value': 25, 'min_value': 3, 'max_value': 120, 'description': '低速期間'},
            },
            'pandas_function': 'massi',
            'data_column': None,
            'data_columns': ['High', 'Low'],
            'returns': 'single',
            'return_cols': None,
        ...
        'yaml': {
            'conditions': {'long': '{left_operand} > {threshold}'},
            'scale_type': 'price_absolute',
            'thresholds': {'normal': {'threshold': 27.0}},
            'type': 'momentum',
        },
    },
    'PSL': {
        'config': {
            ...
            'parameters': {
                'length': {'default_value': 12, 'min_value': 2, 'max_value': 200, 'description': 'PSL期間'},
                'scalar': {'default_value': 100.0, 'min_value': 1.0, 'max_value': 200.0, 'description': 'スケール係数'},
                'drift': {'default_value': 1, 'min_value': 1, 'max_value': 10, 'description': '比較ドリフト'},
            },
            'pandas_function': 'psl',
            'data_column': 'Close',
            'data_columns': None,
            ...
            'return_cols': None,
            'multi_column': False,
            'default_values': {'length': 12, 'scalar': 100.0, 'drift': 1},
            'min_length_func': None,
        },
        'yaml': {
            'conditions': {'long': '{left_operand} > {long_threshold}', 'short': '{left_operand} < {short_threshold}'},
            'scale_type': 'oscillator_0_100',
            'thresholds': {'normal': {'long_threshold': 55, 'short_threshold': 45}},
            'type': 'momentum',
        },
    },
    'PVO': {
    ...
    'EOM': {
        'config': {
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'volume': 'volume', 'length': 'length'},
            'parameters': {'length': {'default_value': 14, 'min_value': 1, 'max_value': 50, 'description': 'EOM計算期間'}},
            'pandas_function': 'eom',
            'data_column': None,
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'momentum_zero_centered', 'thresholds': {'aggressive': {'long_gt': 0.1, 'short_lt': -0.1}, 'conservative': {'long_gt': 0.3, 'short_lt': -0.3}, 'normal': {'long_gt': 0.2, 'short_lt': -0.2}}, 'type': 'volume'},
    },
    'CHAIKIN_OSC': {
        'config': {
            'result_type': 'single',
            'scale_type': 'momentum_zero_centered',
            'category': 'volume',
            'adapter_function': 'app.services.indicators.technical_indicators.volume.VolumeIndicators.chaikin_osc',
            'required_data': ['high', 'low', 'close', 'volume'],
            'output_names': None,
            'default_output': None,
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'close': 'close', 'volume': 'volume', 'fast': 'fast', 'slow': 'slow'},
            'parameters': {'fast': {'default_value': 3, 'min_value': 2, 'max_value': 20, 'description': 'Chaikin Oscillator fast period'}, 'slow': {'default_value': 10, 'min_value': 5, 'max_value': 50, 'description': 'Chaikin Oscillator slow period'}},
            'pandas_function': None,  # 自前実装
            'data_column': None,
    ...
    'PIVOT_POINTS': {
        'config': {
            ...
            'scale_type': 'price_absolute',
            'category': 'volume',
            'adapter_function': 'app.services.indicators.technical_indicators.volume.VolumeIndicators.pivot_points',
            'required_data': ['high', 'low', 'close'],
            'output_names': ['PIVOT', 'R1', 'R2', 'R3', 'S1', 'S2', 'S3'],
            'default_output': 'PIVOT',
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'close': 'close', 'method': 'method'},
            'parameters': {'method': {'default_value': 'standard', 'min_value': None, 'max_value': None, 'description': 'Pivot Points calculation method (standard, woodie, camarilla)'}},
            'pandas_function': None,  # 自前実装
            'data_column': None,
            'data_columns': ['High', 'Low', 'Close'],
            'returns': 'multiple',
            'return_cols': None,
            'multi_column': True,
            'default_values': {'method': 'standard'},
            'min_length_func': None,
        },
        'yaml': {'levels': ['pivot', 'r1', 'r2', 'r3', 's1', 's2', 's3'], 'conditions': {'long': 'close > {left_operand}_pivot', 'short': 'close < {left_operand}_pivot'}, 'scale_type': 'price_absolute', 'thresholds': {'support_resistance': True}, 'type': 'volume'},
    },
    'WMA': {
        'config': {
            'result_type': 'single',
