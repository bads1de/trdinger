...
MANIFEST: Dict[str, Dict[str, Any]] = {
    ...
    'ALMA': {
        'config': {
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length', 'sigma': 'sigma', 'distribution_offset': 'distribution_offset', 'offset': 'offset'},
            'parameters': {
                'length': {'default_value': 10, 'min_value': 2, 'max_value': 200, 'description': 'ALMA計算期間'},
                'sigma': {'default_value': 6.0, 'min_value': 0.1, 'max_value': 10.0, 'description': 'ガウス分布のシグマ'},
                'distribution_offset': {'default_value': 0.85, 'min_value': 0.0, 'max_value': 1.0, 'description': 'ガウス分布のオフセット'},
                'offset': {'default_value': 0, 'min_value': -10, 'max_value': 10, 'description': '出力シフト量'},
            },
            ...
            'return_cols': None,
            'multi_column': False,
            'default_values': {'length': 10, 'sigma': 6.0, 'distribution_offset': 0.85, 'offset': 0},
            'min_length_func': None,
        },
    ...
    'CMO': {
        'config': {
            ...
            'parameters': {'length': {'default_value': 14, 'min_value': 2, 'max_value': 100, 'description': 'CMO計算期間'}},
            'pandas_function': 'cmo',
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'single',
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'oscillator_plus_minus_100', 'thresholds': {'all': {'long_gt': 50, 'short_lt': -50}}, 'type': 'momentum'},
    },
    'DEMA': {
        'config': {
            'result_type': 'single',
    ...
    'FISHER': {
        'config': {
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'length': 'length', 'signal': 'signal'},
            'parameters': {
                'length': {'default_value': 9, 'min_value': 2, 'max_value': 100, 'description': 'Fisher期間'},
                'signal': {'default_value': 1, 'min_value': 1, 'max_value': 20, 'description': 'シグナル期間'}
            },
    ...
    'FRAMA': {
        'config': {
            ...
            'parameters': {
                'length': {'default_value': 16, 'min_value': 4, 'max_value': 200, 'description': 'FRAMA計算ウィンドウ'},
                'slow': {'default_value': 200, 'min_value': 1, 'max_value': 500, 'description': '最大スムージング期間'},
            },
            'pandas_function': None,
            'data_column': None,
            'data_columns': None,
    ...
    'SUPER_SMOOTHER': {
        'config': {
            ...
            'parameters': {
                'length': {'default_value': 10, 'min_value': 2, 'max_value': 200, 'description': 'Super Smoother期間'},
            },
            'pandas_function': None,
            'data_column': None,
            'data_columns': None,
    ...
    'HMA': {
        'config': {
            ...
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length'},
            'parameters': {'length': {'default_value': 20, 'min_value': 2, 'max_value': 200, 'description': 'HMA計算期間'}},
            'pandas_function': 'hma',
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'single',
    ...
    'KST': {
        'config': {
            ...
            'parameters': {
                'roc1': {'default_value': 10, 'min_value': 2, 'max_value': 60, 'description': 'ROC1期間'},
                'roc2': {'default_value': 15, 'min_value': 2, 'max_value': 60, 'description': 'ROC2期間'},
                'roc3': {'default_value': 20, 'min_value': 2, 'max_value': 60, 'description': 'ROC3期間'},
                'roc4': {'default_value': 30, 'min_value': 2, 'max_value': 90, 'description': 'ROC4期間'},
                'sma1': {'default_value': 10, 'min_value': 2, 'max_value': 60, 'description': 'SMA1期間'},
                'sma2': {'default_value': 10, 'min_value': 2, 'max_value': 60, 'description': 'SMA2期間'},
                'sma3': {'default_value': 10, 'min_value': 2, 'max_value': 60, 'description': 'SMA3期間'},
                'sma4': {'default_value': 15, 'min_value': 2, 'max_value': 90, 'description': 'SMA4期間'},
    ...
    'CTI': {
        'config': {
            ...
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length'},
            'parameters': {'length': {'default_value': 12, 'min_value': 2, 'max_value': 200, 'description': 'CTI計算期間'}},
            'pandas_function': 'cti',
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'single',
    ...
    'RVI': {
        'config': {
            ...
            'parameters': {
                'length': {'default_value': 14, 'min_value': 2, 'max_value': 200, 'description': 'RVI計算期間'},
                'scalar': {'default_value': 100.0, 'min_value': 1.0, 'max_value': 200.0, 'description': '指数スケール係数'},
                'refined': {'default_value': False, 'min_value': None, 'max_value': None, 'description': 'Refined モードを使用'},
                'thirds': {'default_value': False, 'min_value': None, 'max_value': None, 'description': 'Thirds モードを使用'},
                'mamode': {'default_value': 'ema', 'min_value': None, 'max_value': None, 'description': '平滑化移動平均モード'},
    ...
    'UO': {
        'config': {
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'close': 'close', 'fast': 'fast', 'medium': 'medium', 'slow': 'slow'},
            'parameters': {
                'fast': {'default_value': 7, 'min_value': 2, 'max_value': 50, 'description': '短期期間'},
                'medium': {'default_value': 14, 'min_value': 3, 'max_value': 100, 'description': '中期期間'},
                'slow': {'default_value': 28, 'min_value': 5, 'max_value': 200, 'description': '長期期間'}
            },
            'pandas_function': 'uo',
            'data_column': None,
            'data_columns': ['High', 'Low', 'Close'],
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_gt': 55, 'short_lt': 45}, 'conservative': {'long_gt': 65, 'short_lt': 35}, 'normal': {'long_gt': 60, 'short_lt': 40}}, 'type': 'momentum'},
    },
    'T3': {
        'config': {
            'result_type': 'single',
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length', 'a': 'a', 'vfactor': 'vfactor'},
            'parameters': {
                'length': {'default_value': 5, 'min_value': 2, 'max_value': 50, 'description': 'T3移動平均期間'},
                'a': {'default_value': 0.7, 'min_value': 0.1, 'max_value': 1.0, 'description': 'T3スムージングファクター'},
                'vfactor': {'default_value': 0.7, 'min_value': 0.1, 'max_value': 1.0, 'description': 'pandas-ta互換用パラメータ'},
            },
            'pandas_function': 't3',
            'data_column': 'Close',
            'data_columns': None,
    ...
    'APO': {
        'config': {
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'close': 'data', 'fast': 'fast', 'slow': 'slow', 'ma_mode': 'ma_mode'},
            'parameters': {
                'fast': {'default_value': 12, 'min_value': 2, 'max_value': 100, 'description': '短期EMA期間'},
                'slow': {'default_value': 26, 'min_value': 5, 'max_value': 200, 'description': '長期EMA期間'},
                'ma_mode': {'default_value': 'ema', 'min_value': None, 'max_value': None, 'description': '移動平均モード'},
            },
            'pandas_function': 'apo',
            'data_column': 'Close',
            'data_columns': None,
        ...
        'yaml': {'conditions': {'long': '{left_operand} > 0', 'short': '{left_operand} < 0'}, 'scale_type': 'momentum_zero_centered', 'thresholds': {'zero_cross': True}, 'type': 'momentum'},
    },
    'LINREG': {
        'config': {
            'result_type': 'single',
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length', 'scalar': 'scalar', 'intercept': 'intercept'},
            'parameters': {
                'length': {'default_value': 14, 'min_value': 2, 'max_value': 200, 'description': '回帰期間'},
                'scalar': {'default_value': 1.0, 'min_value': 0.1, 'max_value': 10.0, 'description': 'スケーリング係数'},
                'intercept': {'default_value': False, 'min_value': None, 'max_value': None, 'description': '切片を返すかどうか'},
            },
            'pandas_function': 'linreg',
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'single',
            'return_cols': None,
    ...
    'LINREGSLOPE': {
        ...
        'yaml': {'conditions': {'long': '{left_operand} > 0', 'short': '{left_operand} < 0'}, 'scale_type': 'momentum_zero_centered', 'thresholds': {'zero_cross': True}, 'type': 'trend'},
    },
    'NATR': {
        'config': {
            'result_type': 'single',
            ...
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'close': 'close', 'length': 'length'},
            'parameters': {'length': {'default_value': 14, 'min_value': 2, 'max_value': 200, 'description': 'NATR計算期間'}},
        ...
        'yaml': {'conditions': {'long': '{left_operand} < {threshold}', 'short': '{left_operand} > {threshold}'}, 'scale_type': 'momentum_zero_centered', 'thresholds': {'aggressive': {'long_lt': 1.5, 'short_gt': 5.0}, 'normal': {'long_lt': 2.0, 'short_gt': 4.0}, 'conservative': {'long_lt': 2.5, 'short_gt': 3.5}}, 'type': 'volatility'},
    },
    'KVO': {
        'config': {
            'result_type': 'complex',
            ...
            'parameters': {
                'fast': {'default_value': 34, 'min_value': 2, 'max_value': 100, 'description': '短期EMA期間'},
                'slow': {'default_value': 55, 'min_value': 5, 'max_value': 200, 'description': '長期EMA期間'},
                'signal': {'default_value': 13, 'min_value': 1, 'max_value': 100, 'description': 'シグナルEMA期間'},
                'scalar': {'default_value': 100.0, 'min_value': 1.0, 'max_value': 200.0, 'description': 'スケール係数'},
                'mamode': {'default_value': 'ema', 'min_value': None, 'max_value': None, 'description': '平滑化モード'},
                'drift': {'default_value': 1, 'min_value': 1, 'max_value': 10, 'description': '差分に用いるドリフト'},
            },
            'pandas_function': 'kvo',
            'data_column': None,
            'data_columns': ['High', 'Low', 'Close', 'Volume'],
            ...
            'multi_column': True,
            'default_values': {'fast': 34, 'slow': 55, 'signal': 13, 'scalar': 100.0, 'mamode': 'ema', 'drift': 1},
            'min_length_func': None,
        },
        'yaml': {'conditions': {'long': '{left_operand}_0 > 0', 'short': '{left_operand}_0 < 0'}, 'scale_type': 'momentum_zero_centered', 'thresholds': {'zero_cross': True}, 'type': 'volume'},
    },
    'PVO': {
        'config': {
            'result_type': 'complex',
            ...
            'parameters': {
                'fast': {'default_value': 12, 'min_value': 1, 'max_value': 200, 'description': '高速EMA期間'},
                'slow': {'default_value': 26, 'min_value': 2, 'max_value': 300, 'description': '低速EMA期間'},
                'signal': {'default_value': 9, 'min_value': 1, 'max_value': 200, 'description': 'シグナル期間'},
                'scalar': {'default_value': 100.0, 'min_value': 1.0, 'max_value': 200.0, 'description': 'スケール係数'},
            },
            'pandas_function': 'pvo',
            'data_columns': ['Volume'],
        ...
        'yaml': {
            'conditions': {'long': '{left_operand}_0 > 0', 'short': '{left_operand}_0 < 0'},
            'scale_type': 'momentum_zero_centered',
            'thresholds': {'zero_cross': True},
            'type': 'volume',
        },
    ...
    'TRIMA': {
        'config': {
            ...
            'parameters': {'length': {'default_value': 10, 'min_value': 2, 'max_value': 200, 'description': 'TRIMA期間'}},
    ...
    'VWMA': {
        'config': {
            ...
            'parameters': {'length': {'default_value': 20, 'min_value': 2, 'max_value': 200, 'description': 'VWMA期間'}},
    ...
    'ZLMA': {
        'config': {
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length', 'mamode': 'mamode', 'offset': 'offset'},
            'parameters': {
                'length': {'default_value': 10, 'min_value': 2, 'max_value': 200, 'description': 'ZLMA期間'},
                'mamode': {'default_value': 'ema', 'min_value': None, 'max_value': None, 'description': '元となる移動平均モード'},
                'offset': {'default_value': 0, 'min_value': -10, 'max_value': 10, 'description': 'シフト量'}
            },
    ...
    'STC': {
        'config': {
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'close': 'data', 'fast': 'fast', 'slow': 'slow', 'cycle': 'cycle', 'd1': 'd1', 'd2': 'd2'},
            'parameters': {'fast': {'default_value': 23, 'min_value': 2, 'max_value': 50, 'description': 'STC fast period'}, 'slow': {'default_value': 50, 'min_value': 5, 'max_value': 100, 'description': 'STC slow period'}, 'cycle': {'default_value': 10, 'min_value': 3, 'max_value': 50, 'description': 'STC cycle period'}, 'd1': {'default_value': 3, 'min_value': 2, 'max_value': 20, 'description': 'STC first smoothing'}, 'd2': {'default_value': 3, 'min_value': 2, 'max_value': 20, 'description': 'STC second smoothing'}},
            'pandas_function': 'stc',
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'single',
        ...
        'yaml': {'conditions': {'long': '{left_operand} < {threshold}', 'short': '{left_operand} > {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_lt': 25, 'short_gt': 75}, 'conservative': {'long_lt': 35, 'short_gt': 65}, 'normal': {'long_lt': 30, 'short_gt': 70}}, 'type': 'momentum'},
    },
    'WMA': {
        'config': {
            'result_type': 'single',
    ...
    'TSI': {
        'config': {
            ...
            'aliases': None,
            'param_map': {'close': 'data', 'fast': 'fast', 'slow': 'slow', 'signal': 'signal', 'scalar': 'scalar', 'mamode': 'mamode', 'drift': 'drift'},
            'parameters': {
                'fast': {'default_value': 13, 'min_value': 2, 'max_value': 50, 'description': 'TSI短期期間'},
                'slow': {'default_value': 25, 'min_value': 5, 'max_value': 50, 'description': 'TSI長期期間'},
                'signal': {'default_value': 13, 'min_value': 1, 'max_value': 50, 'description': 'TSIシグナル期間'},
                'scalar': {'default_value': 100.0, 'min_value': 1.0, 'max_value': 200.0, 'description': 'TSIスカラー'},
                'mamode': {'default_value': 'ema', 'min_value': None, 'max_value': None, 'description': '移動平均モード'},
                'drift': {'default_value': 1, 'min_value': 1, 'max_value': 10, 'description': 'ドリフト期間'},
            },
            'pandas_function': 'tsi',
            'data_column': 'Close',
            ...
            'multi_column': False,
            'default_values': {'fast': 13, 'slow': 25, 'signal': 13, 'scalar': 100.0, 'mamode': 'ema', 'drift': 1},
            'min_length_func': None,
        },
        'yaml': {'conditions': {'long': '{left_operand}_0 > {threshold}', 'short': '{left_operand}_0 < {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_gt': 25, 'short_lt': -25}, 'conservative': {'long_gt': 40, 'short_lt': -40}, 'normal': {'long_gt': 30, 'short_lt': -30}}, 'type': 'momentum'},
    },
    'PGO': {
        'config': {
            'result_type': 'single',
            ...
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'close': 'close', 'length': 'length'},
            'parameters': {'length': {'default_value': 14, 'min_value': 2, 'max_value': 50, 'description': 'PGO計算期間'}},
            'pandas_function': None,
            'data_column': None,
            'data_columns': None,
            'returns': 'single',
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'oscillator_plus_minus_100', 'thresholds': {'aggressive': {'long_gt': 10, 'short_lt': -10}, 'conservative': {'long_gt': 40, 'short_lt': -40}, 'normal': {'long_gt': 25, 'short_lt': -25}}, 'type': 'momentum'},
    },
    'MASSI': {
        'config': {
            'result_type': 'single',
            ...
            'parameters': {'fast': {'default_value': 9, 'min_value': 2, 'max_value': 20, 'description': '短期EMA期間'}, 'slow': {'default_value': 25, 'min_value': 10, 'max_value': 50, 'description': '長期EMA期間'}},
            'pandas_function': None,
            'data_column': None,
            'data_columns': None,
            'returns': 'single',
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_gt': 85, 'short_lt': 65}, 'conservative': {'long_gt': 95, 'short_lt': 85}, 'normal': {'long_gt': 90, 'short_lt': 75}}, 'type': 'momentum'},
    },
    'PSL': {
        'config': {
            'result_type': 'single',
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'close': 'close', 'length': 'length', 'scalar': 'scalar', 'drift': 'drift', 'open_': 'open_'},
            'parameters': {
                'length': {'default_value': 12, 'min_value': 2, 'max_value': 50, 'description': '心理ライン期間'},
                'scalar': {'default_value': 100.0, 'min_value': 1.0, 'max_value': 200.0, 'description': 'スケーリング係数'},
                'drift': {'default_value': 1, 'min_value': 1, 'max_value': 10, 'description': 'ドリフト期間'},
                'open_': {'default_value': None, 'min_value': None, 'max_value': None, 'description': '始値データ'},
            },
            'pandas_function': None,
            'data_column': None,
            'data_columns': None,
            ...
            'return_cols': None,
            'multi_column': False,
            'default_values': {'length': 12, 'scalar': 100.0, 'drift': 1, 'open_': None},
            'min_length_func': None,
        },
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_gt': 65, 'short_lt': 35}, 'conservative': {'long_gt': 80, 'short_lt': 20}, 'normal': {'long_gt': 75, 'short_lt': 25}}, 'type': 'momentum'},
    },
    'AO': {
        'config': {
            'result_type': 'single',
            ...
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'fast': 'fast', 'slow': 'slow'},
            'parameters': {'fast': {'default_value': 5, 'min_value': 2, 'max_value': 20, 'description': 'AO短期期間'}, 'slow': {'default_value': 34, 'min_value': 10, 'max_value': 50, 'description': 'AO長期期間'}},
            'pandas_function': 'ao',
            'data_column': None,
            'data_columns': ['High', 'Low'],
            'returns': 'single',
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'momentum_zero_centered', 'thresholds': {'aggressive': {'long_gt': 0.1, 'short_lt': -0.1}, 'conservative': {'long_gt': 0.3, 'short_lt': -0.3}, 'normal': {'long_gt': 0.2, 'short_lt': -0.2}}, 'type': 'momentum'},
    },
    'AROON': {
        'config': {
            'result_type': 'complex',
            ...
            'parameters': {'length': {'default_value': 14, 'min_value': 2, 'max_value': 50, 'description': 'AROON期間'}},
        ...
        'yaml': {'conditions': {'long': '{left_operand}_0 > {threshold}', 'short': '{left_operand}_1 < {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_gt': 70, 'short_lt': 30}, 'conservative': {'long_gt': 90, 'short_lt': 10}, 'normal': {'long_gt': 80, 'short_lt': 20}}, 'type': 'momentum'},
    },
    'CHOP': {
        'config': {
            'result_type': 'single',
            ...
            'aliases': None,
            'param_map': {'high': 'high', 'low': 'low', 'close': 'close', 'length': 'length'},
            'parameters': {'length': {'default_value': 14, 'min_value': 2, 'max_value': 50, 'description': 'CHOP期間'}},
        ...
        'yaml': {'conditions': {'long': '{left_operand} < {threshold}', 'short': '{left_operand} > {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_lt': 40, 'short_gt': 60}, 'conservative': {'long_lt': 20, 'short_gt': 80}, 'normal': {'long_lt': 30, 'short_gt': 70}}, 'type': 'volatility'},
    },
    'BOP': {
        'config': {
            'result_type': 'single',
            ...
            'default_output': None,
            'aliases': None,
            'param_map': {'open': 'open_', 'high': 'high', 'low': 'low', 'close': 'close'},
            'parameters': {},
            'pandas_function': 'bop',
            'data_column': None,
    ...
    'CG': {
        'config': {
            ...
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length'},
            'parameters': {'length': {'default_value': 10, 'min_value': 2, 'max_value': 50, 'description': 'CG期間'}},
            'pandas_function': 'cg',
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'single',
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_gt': 60, 'short_lt': 40}, 'conservative': {'long_gt': 80, 'short_lt': 20}, 'normal': {'long_gt': 70, 'short_lt': 30}}, 'type': 'momentum'},
    },
    'COPPOCK': {
        'config': {
            'result_type': 'single',
            ...
            'default_output': None,
            'aliases': ['COPC'],
            'param_map': {'close': 'close', 'length': 'length', 'fast': 'fast', 'slow': 'slow'},
            'parameters': {'length': {'default_value': 11, 'min_value': 5, 'max_value': 30, 'description': 'Coppock主期間'}, 'fast': {'default_value': 14, 'min_value': 5, 'max_value': 30, 'description': '短期期間'}, 'slow': {'default_value': 10, 'min_value': 5, 'max_value': 30, 'description': '長期期間'}},
        ...
        'yaml': {'conditions': {'long': '{left_operand} > {threshold}', 'short': '{left_operand} < {threshold}'}, 'scale_type': 'oscillator_0_100', 'thresholds': {'aggressive': {'long_gt': 50, 'short_lt': 30}, 'conservative': {'long_gt': 80, 'short_lt': 20}, 'normal': {'long_gt': 60, 'short_lt': 40}}, 'type': 'momentum'},
    },
    'AMAT': {
        'config': {
            'result_type': 'single',
            ...
            'aliases': None,
            'param_map': {'close': 'data', 'fast': 'fast', 'slow': 'slow', 'signal': 'signal'},
            'parameters': {'fast': {'default_value': 3, 'min_value': 2, 'max_value': 20, 'description': 'AMAT短期期間'}, 'slow': {'default_value': 30, 'min_value': 10, 'max_value': 50, 'description': 'AMAT長期期間'}, 'signal': {'default_value': 10, 'min_value': 5, 'max_value': 30, 'description': 'シグナル期間'}},
    ...
    'RMA': {
        'config': {
            ...
            'aliases': None,
            'param_map': {'close': 'data', 'length': 'length'},
            'parameters': {'length': {'default_value': 10, 'min_value': 2, 'max_value': 50, 'description': 'RMA期間'}},
            'pandas_function': 'rma',
            'data_column': 'Close',
            'data_columns': None,
            'returns': 'single',
