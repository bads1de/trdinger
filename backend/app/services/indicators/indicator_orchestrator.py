...
- Original: ADAPTIVE_ENTROPY, CHAOS_FRACTAL_DIM, ELDER_RAY, FIBO_CYCLE, FRAMA, GRI, HARMONIC_RESONANCE, PRIME_OSC, QUANTUM_FLOW, SUPER_SMOOTHER, MCGINLEY_DYNAMIC, KAUFMAN_EFFICIENCY_RATIO, CHANDE_KROLL_STOP, TREND_INTENSITY_INDEX (14個)

※ 50個はpandas-ta直接対応、34個は独自実装によるアダプター方式
