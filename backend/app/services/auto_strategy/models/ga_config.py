...
class GAConfig(BaseConfig):
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GAConfig":
        ...
        return cls(
            population_size=data.get("population_size", GA_DEFAULT_CONFIG["population_size"]),
            generations=data.get("generations", GA_DEFAULT_CONFIG["generations"]),
            crossover_rate=data.get("crossover_rate", GA_DEFAULT_CONFIG["crossover_rate"]),
            ...
            fitness_constraints=data.get("fitness_constraints", DEFAULT_FITNESS_CONSTRAINTS),
            max_indicators=data.get("max_indicators", GA_DEFAULT_CONFIG["max_indicators"]),
            ...
            # フィットネス共有設定
            enable_fitness_sharing=data.get("enable_fitness_sharing", GA_DEFAULT_FITNESS_SHARING["enable_fitness_sharing"]),
            sharing_radius=data.get("sharing_radius", GA_DEFAULT_FITNESS_SHARING["sharing_radius"]),
            sharing_alpha=data.get("sharing_alpha", GA_DEFAULT_FITNESS_SHARING["sharing_alpha"]),
            # 指標モード設定
            ...
            objective_weights=data.get("objective_weights", DEFAULT_GA_OBJECTIVE_WEIGHTS),
        )
