...
class MarketDataFeatureCalculator:
    ...
    def calculate_funding_rate_features(
        ...
        try:
            ...
            result_df['FR_MA_168'] = merged_df[fr_column].rolling(window=168).mean()  # 1週間
            
            # ファンディングレート変化
            result_df['FR_Change'] = merged_df[fr_column].diff()
            result_df['FR_Change_Rate'] = merged_df[fr_column].pct_change()
            ...
            # ファンディングレートボラティリティ
            result_df['FR_Volatility'] = merged_df[fr_column].rolling(window=24).std()
    ...
    def calculate_open_interest_features(
        ...
        try:
            ...
            result_df['OI_Change_Rate_24h'] = merged_df[oi_column].pct_change(24)
            ...
            result_df['OI_MA_168'] = merged_df[oi_column].rolling(window=168).mean()
