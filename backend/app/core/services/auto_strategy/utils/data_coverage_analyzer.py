    ...
    def analyze_strategy_coverage(
        ...
        try:
            ...
            for source in used_special_sources:
                ...
                # ペナルティを計算
                penalty = self._calculate_coverage_penalty(coverage_info["coverage_ratio"])
            ...
            # 平均ペナルティを計算
            avg_penalty = total_penalty / len(used_special_sources) if used_special_sources else 0.0
