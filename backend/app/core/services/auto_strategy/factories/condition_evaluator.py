...
class ConditionEvaluator:
    ...
    def evaluate_condition(self, condition: Condition, strategy_instance) -> bool:
        ...
        try:
            ...
            if operator == ">":
                ...
                return self._check_cross_above(
                    left_value, right_value, strategy_instance
                )
            elif operator == "cross_below":
                return self._check_cross_below(
                    left_value, right_value, strategy_instance
                )
            else:
    ...
    def _check_cross_above(
        self, left_value: float, right_value: float, strategy_instance
    ) -> bool:
        """
        クロスアバブ（上抜け）をチェック
