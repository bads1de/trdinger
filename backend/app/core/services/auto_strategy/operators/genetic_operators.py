...
def mutate_with_short_bias(
    ...
    通常の突然変異に加え、ショート戦略に有利な条件を生成しやすくします。

    Args:
        gene: 突然変異対象の戦略遺伝子
        mutation_rate: 突然変異率
        short_bias_rate: ショートバイアス率
