    ...
    def generate_labels(
        ...
        **kwargs
        ...
        try:
            ...
            # ラベルを生成
            labels = pd.Series(1, index=price_change.index, dtype=int)  # デフォルト：レンジ
    ...
    def _calculate_thresholds(
        ...
        **kwargs
        ...
        if method == ThresholdMethod.FIXED:
            ...
            return self._calculate_quantile_thresholds(price_change, target_distribution, **kwargs)
            ...
            return self._calculate_adaptive_thresholds(price_change, target_distribution, **kwargs)
        else:
