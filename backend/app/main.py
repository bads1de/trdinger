...
def create_app() -> FastAPI:
    ...
    app.include_router(auto_strategy_router, prefix="/api")
    app.include_router(strategies_router, prefix="/api")
    app.include_router(ml_training_router, prefix="/api")
    app.include_router(ml_management_router, prefix="/api")
    app.include_router(bayesian_optimization_router, prefix="/api")
